...
from openmdao.lib.casehandlers.pymongo_bson.errors import InvalidId
from openmdao.lib.casehandlers.pymongo_bson.py3compat import (PY3, b, binary_type, text_type,
