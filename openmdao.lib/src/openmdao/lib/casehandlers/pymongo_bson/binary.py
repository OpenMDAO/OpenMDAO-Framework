...
from openmdao.lib.casehandlers.pymongo_bson.py3compat import PY3, binary_type
...
class UUIDLegacy(Binary):
    ...
    .. doctest::
      ...
      >>> import uuid
      >>> from openmdao.lib.casehandlers.pymongo_bson.binary import Binary, UUIDLegacy, UUID_SUBTYPE
      >>> my_uuid = uuid.uuid4()
      >>> coll = db.test
