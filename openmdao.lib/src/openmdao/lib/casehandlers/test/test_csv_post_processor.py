...
class CSVPostProcessorTestCase(unittest.TestCase):
    ...
    def test_flatten(self):
        ...
        expected = [
            'Case:',
             '   uuid: 54c69c07-7323-11e4-800d-20c9d0478eff',
             '   timestamp: 1416755631.130975',
             '   parent_uuid: 54c1cfdc-7323-11e4-bf85-20c9d0478eff',
             '   inputs:',
             '      comp1.x_array[0]: 2.0',
             '      comp1.x_array[1]: 2.0',
             '      comp1.x_array[2]: 2.0',
        ...
        expected = [
            'Case:',
            '   uuid: 23a99330-78ac-11e4-800d-20c9d0478eff',
            '   timestamp: 1417364145.598181',
            '   parent_uuid: 23a42487-78ac-11e4-a703-20c9d0478eff',
            '   inputs:',
            '      comp1.x_array[0]: 2.0',
            '      comp1.x_array[1]: 2.0',
            '      comp1.x_array[2]: 2.0',
