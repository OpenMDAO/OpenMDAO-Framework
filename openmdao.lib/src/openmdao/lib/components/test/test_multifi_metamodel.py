...
class MultiFiMetaModelTestCase(unittest.TestCase):
    ...
    def test_two_dim_bi_fidelity_training(self):
        ...
        mock_surr_y1.train.assert_called_with(expected_xtrain, expected_y1train)                
        mock_surr_y2.train.assert_called_with(expected_xtrain, expected_y2train)                
