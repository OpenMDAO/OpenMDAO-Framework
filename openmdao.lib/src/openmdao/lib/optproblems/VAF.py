...
class Structural(Component): 
    ...
    F = Float(0.02,units="N", iotype="in", desc="Aerodynamic force on the stator flap")
...
class StructuralAsmb(Assembly): 
    ...
    def configure(self): 
        self.add('strut_comp',Structural())
        ...
        self.driver.add_constraint('struct.theta_residual=0')
...
class Aerodynamics(Component): 
    ...
    F = Float(0.02,units="N", iotype="out", desc="Aerodynamic force on the stator flap")
