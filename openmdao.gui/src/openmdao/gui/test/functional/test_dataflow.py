...
def _test_column_sorting(browser):
    ...
    test_sorting(
        ["accuracy", "iout", "iprint", "maxiter",
         "output_filename", "directory", "force_execute", "force_fd",
         " gradient_options", "derivative_direction", "directional_fd", "fd_form", "fd_step", "fd_step_type",
    ...
    test_sorting(
         ...
         "force_fd", "fd_step_type", "fd_step", "fd_form", "directional_fd", "derivative_direction",
