...
def _test_column_sorting(browser):
    ...
    test_sorting(
        ["accuracy", " gradient_options", "iout", "iprint", "maxiter", "output_filename", "printvars", "directory", "force_execute", "force_fd"],
        "inputs",
        SortOrder.ASCENDING
    )

    test_sorting(
        ["force_fd", "force_execute", "directory", "printvars", "output_filename", "maxiter", "iprint", "iout", " gradient_options", "accuracy"],
        "inputs",
