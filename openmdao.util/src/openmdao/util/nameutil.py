...
def dotted_names_to_dict(names, dct=None):
    """Take an iterator of names and return a dict (possibly nested)
    with container names keyed to lists of variable or container names.  
    Simple names (having no '.' in them) will have a key of None.
