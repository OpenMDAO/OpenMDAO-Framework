...
def after_install(options, home_dir, activated=False):
    ...
    reqs = ['Fabric==0.9.3', 'Jinja2==2.7.3', 'Pyevolve==0.6', 'Pygments==1.6', 'boto==2.36.0', 'bson==0.3.3', 'cobyla==1.0.2', 'conmin==1.0.2', 'decorator==3.4.0', 'docutils==0.12', 'mock==1.0.1', 'networkx==1.9.1', 'newsumt==1.1.1', 'nose==1.3.4', 'paramiko==1.7.7.1', 'pycrypto==2.3', 'pyparsing==2.0.3', 'pytz==2014.9', 'requests==2.5.3', 'setupdocs>=1.0', 'slsqp==1.0.2', 'sphinx==1.2.2', 'traits==4.3.0', 'virtualenv==12.0.7', 'zope.interface==4.1.2']
