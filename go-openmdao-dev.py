...
def after_install(options, home_dir):
    global logger
    reqs = ['numpy', 'docutils==0.6', 'Pyevolve==0.6', 'coverage==3.3.1', 'Pygments==1.3.1', 'pycrypto==2.0.1', 'ordereddict==1.1', 'Traits==3.3.0', 'PyYAML==3.09', 'Jinja2==2.4', 'virtualenv==1.4.6', 'zc.buildout==1.4.3', 'Fabric==0.9.0', 'Sphinx==1.0b2', 'networkx==1.0.1', 'pyparsing==1.5.2', 'nosecoverage2==0.1', 'conmin==1.0.1', 'nose==0.11.3']
    cmds = []
