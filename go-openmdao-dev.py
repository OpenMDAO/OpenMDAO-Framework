...
def after_install(options, home_dir, activated=False):
    ...
    reqs = ['SetupDocs==1.0.5', 'docutils==0.10', 'Pyevolve==0.6', 'networkx==1.8.1', 'slsqp==1.0.1', 'virtualenv==1.9.1', 'pyparsing==2.0.1', 'Pygments==1.3.1', 'pyV3D==0.4.1', 'argparse==1.2.1', 'nose==0.11.3', 'zope.interface==3.6.1', 'Sphinx==1.1.3', 'requests==0.13.3', 'Jinja2==2.4', 'decorator==3.2.0', 'ordereddict==1.1', 'newsumt==1.1.0', 'Traits==4.3.0', 'boto==2.0rc1', 'cobyla==1.0.1', 'paramiko==1.7.7.1', 'Fabric==0.9.3', 'sympy==0.7.1', 'tornado==2.2.1', 'conmin==1.0.1', 'pycrypto==2.3']
