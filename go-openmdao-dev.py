...
def after_install(options, home_dir):
    global logger
    reqs = ['docutils==0.6', 'Pyevolve==0.6', 'coverage==3.3.1', 'pycrypto==2.0.1', 'Traits==3.3.0', 'numpy==1.3.0', 'PyYAML==3.09', 'conmin==1.0', 'Jinja2==2.4', 'virtualenv==1.4.5', 'zc.buildout==1.4.3', 'Sphinx==0.6.5', 'Fabric==0.9.0', 'networkx==1.0.1', 'pyparsing==1.5.2', 'nosecoverage2==0.1', 'Pygments==1.3.1', 'nose==0.11.3']
    cmds = []
