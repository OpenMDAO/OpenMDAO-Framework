...
def after_install(options, home_dir):
    ...
    reqs = ['SetupDocs==1.0.5', 'docutils==0.6', 'Pyevolve==0.6', 'newsumt==1.1.0', 'Pygments==1.3.1', 'ordereddict==1.1', 'boto==2.0rc1', 'pycrypto==2.3', 'paramiko==1.7.7.1', 'decorator==3.2.0', 'Jinja2==2.4', 'Sphinx==1.0.6', 'Traits==3.3.0', 'Fabric==0.9.3', 'nose==0.11.3', 'zope.interface==3.6.1', 'networkx==1.3', 'pyparsing==1.5.2', 'conmin==1.0.1', 'virtualenv==1.6.4', 'argparse==1.2.1']
