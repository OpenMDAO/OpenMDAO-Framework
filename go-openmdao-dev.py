...
def after_install(options, home_dir, activated=False):
    ...
    guitestreqs = ['EasyProcess==0.1.4', 'PyVirtualDisplay==0.1.0', 'entrypoint2==0.0.5', 'lazr.testing==0.1.2a', 'mocker==1.1', 'path.py==2.2.2', 'selenium==2.20.0', 'zope.exceptions==3.6.1', 'zope.testing==4.1.1', 'zope.testrunner==4.0.4']
