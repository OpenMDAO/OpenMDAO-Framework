...
class NPSSTestCase(unittest.TestCase):
    ...
    def test_set_then_get(self):
        self.sample.i = 91919
        self.assertEqual(self.sample.i, 91919)
    ...
    def test_setting_npss_var_to_wrong_type(self):
        try:
            ...
            msg = "Can't set 'sample.i': ERROR(91041001) NCPVal error -" \
                  " tried to read a STRING as a INT"
    ...
    def test_after_session_closed(self):
        ...
        try:
            ...
            msg = 'exists(sample.i) failed: no active session'
            self.assertEqual(msg, str(err))
        else:
            self.fail('RuntimeError expected')
        try:
            ...
            msg = 'exists(kid.foobar) failed: no active session'
            self.assertEqual(msg, str(err))
        else:
            self.fail('RuntimeError expected')
    ...
    def test_units(self):
        ...
        self.assertEqual(self.npss.have_units_translation('no_such_unit'),
                         False)
        ...
        self.assertEqual(self.npss.get_units_translation('no_such_unit'),
                         'xyzzy')
