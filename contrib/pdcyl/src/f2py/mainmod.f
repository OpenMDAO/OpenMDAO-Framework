...
C Structural Concept
      ...
      INTEGER  KCONT(12)   ! Structural Geometry Concept Top/Bottom
      INTEGER  KCONB(12)   ! 2 - Simply stiffened shell, frames, sized for minimum weight in buckling
...
C Material Properties
      REAL     FTST(12)    ! Tensile Strength on top/bottom             (psi)
      REAL     FTSB(12)
      REAL     FCST(12)    ! Compressive Strength top/bottom            (psi)
      REAL     FCSB(12)
      REAL     EST(12)     ! Young's Modulus for the shells top/bottom  (psi)
      REAL     ESB(12)
      REAL     EFT(12)     ! Young's Modulus for the frames top/bottom  (psi)
      REAL     EFB(12)
      REAL     DST(12)     ! Density of shell material on top/bottom    (lb/in^3)
      REAL     DSB(12)
      REAL     DFT(12)     ! Density of frame material on top/bottom    (lb/in^3)
      REAL     DFB(12)
      REAL     TMGT(12)    ! Minimum gage thickness top/bottom          (in)
      REAL     TMGB(12)
...
c     INTEGER  ILOAD       ! 1 - Analyze maneuver only
      ...
      REAL     PGT(12)     ! Fuselage gage pressure on top/bottom       (psi)
      REAL     PGB(12)
