...
C        TG=TMG
C        NJ=2
C      replacing Arithmetic IF
       IF((TBM-TBT).LE.0.) THEN 
         TB=TBT
         TG=TB/CK
         NJ=1
       ELSE
...
C       IF(TBB-TBC)300,300,330
        IF((TBB-TBC).LE.0.) THEN 
          GO TO 300 
        ELSE
           GO TO 330
        ENDIF
C 
C300     IF(TBC-TBT)310,310,354
300     IF((TBC-TBT).LE.0.) THEN 
          GO TO 310
        ELSE
           GO TO 354
        ENDIF 
C 
C310     IF(TBT-TBM)320,320,370
310     IF((TBT-TBM).LE.0.) THEN 
          GO TO 320
        ELSE
          GO TO 370
        ENDIF
...
320     TB=TBM
        ...
        NJ=3
        GO TO 380
C330     IF(TBB-TBT)310,310,340
330     IF((TBB-TBT).LE.0.) THEN
          GO TO 310
        ELSE
           GO TO 340
        ENDIF 
C 
C340     IF(TBB-TBM)320,320,350
340     IF((TBB-TBM).LE.0.) THEN
          GO TO 320
        ELSE
          GO TO 350
        ENDIF
...
350     TB=TBB
        ...
        NJ=4
        GO TO 390
C354     IF(TBC-TBM)320,320,360
354     IF((TBC-TBM).LE.0.) THEN
          GO TO 320
        ELSE
           GO TO 360
        ENDIF 
