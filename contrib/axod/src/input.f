...
10    READ(5,6669,END=9999) (XNAME(I),I=1,20)
20    READ(5,6669) (TITLE(I),I=1,20)
      J=0
      endstg=0.0
30    DO 25 L=1,37
      DO 25 I=1,6
...
110   RPMK(K)=RPM
      IF (K-1)120,120,130
120   WRITE(6,6670)XNAME,TITLE,TTIN,PTIN,WAIR,FAIR,PTPS,DELC,DELL,
     1dela,STG,SECT,EXPN,EXPP,RG,PAF,SLI,AACS,RPM,VCTD,EXPRE,
     *WG,ENDSTG,ENDJOB,DHFIND,PFIND,iar,epr,
     1PCNH
      J=J+1
130   WRITE(6,6671)    K,GAMG,DR,DT,RWG,TWG,pwg,
     *SESTH,RERTH,RPM,SDIA,SDEA,SREC,SETA,SCF, SPA,RVU1,
     1RDIA,RDEA,RREC,RETA,RCF,RTF,RPA,RVU2
140   IF (OMEGAS(1,K))160,160,150
150   WRITE(6,6672)STPLC,SINR,SINMP,SINMN,SCPS,SCPC,SCPQ,SCNS,SCNC,SCNQ,
     1RTPLC,RINR,RINMP,RINMN,RCPS,RCPC,RCPQ,RCNS,RCNC,RCNQ
160   J=J+1
180   AM= J-2*(J/2)
