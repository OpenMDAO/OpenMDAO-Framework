...
C                       PRINT OUT FOR STAGE PERFORMANCE
      I=1
      WRITE(6,1000)XNAME,TITLE,ICASE,ISCASE
...
C
21    WRITE(6,1045)XNAME,TITLE,ICASE,ISCASE
1045  FORMAT(1H1,6X,20A4/
     1  6X,20A4/ 30X,6HCASE  ,I3,1H.,I3)
22    WRITE(6,1044) OPSIP,OPSIR,ODELHT,OWNED,OTORQ,OWRTP,ONRT,ODHT,
...
1044  FORMAT(  47X,19HOVERALL PERFORMANCE/
     ...
     &F12.5/6X,7HPT/T EQ,F12.5,5X,7HPT/S EQ,F12.5)
      WRITE(6,1046)WGT0(1),SWRTED(1),PT0PS1(IP,1)
