...
171   PTRS2(I,K)=PTR2(I,K)/PS2(I,K)
...
320   IF(WGT2(K)-WGT2C(K))12,15,11
...
18    WRITE(6,1000)K,PRUP,PRLOW,WE,PRCRIT,J,WGT2(K),WGT2C(K),(WG2(L,K),
     1 L=1,ISECT)
      WRITE(6,1001)(PTRS2(L,K),L=1,ISECT)
