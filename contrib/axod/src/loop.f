...
c     WRITE(6,2001)IBRC,LBRC,ISORR,KN,LSTG,IPC,ISS,ICHOKE,JUMP,LBRCS,
...
c error in index calculation above
	if (j.gt.8) then
	 WRITE(6,801)IBRC,PTrs2(IP,J-8)
	 else
      WRITE(6,801)IBRC,PT0PS1(IP,J)
	endif
...
20    WRITE(6,2001)IBRC,LBRC,ISORR,KN,LSTG,IPC,ISS,ICHOKE,JUMP,LBRCS,
