...
The figure `Component Publishing`_ demonstrates that component developers can choose to
...
(Also see the section on component publishing under :ref:`Key-Concepts`.)
