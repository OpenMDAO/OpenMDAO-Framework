...
The docstring is slightly different depending on your version of numpy.
If numpy is older than version 1.8.0, you'll see docstrings in
...
Otherwise, f2py generates docstrings like the following:
