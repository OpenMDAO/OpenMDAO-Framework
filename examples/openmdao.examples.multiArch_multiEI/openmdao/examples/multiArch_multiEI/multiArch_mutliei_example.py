...
from openmdao.examples.multiArch_multiEI.alg_component1 import Alg_Component1
from openmdao.examples.multiArch_multiEI.alg_component2 import Alg_Component2
...
class MyDriver(Driver):
    def execute(self):
        ...
        print "x : ", analysis.alg1_meta_model.x
        case = Case(inputs = [('alg1_meta_model.x',None,analysis.alg1_meta_model.x)],
                    outputs = [('alg1_meta_model.f1',None,analysis.alg1_meta_model.f1),
                               ('alg1_meta_model.f2',None,analysis.alg1_meta_model.f2)])
...
if __name__ == "__main__": #pragma: no cover
    ...
    print [case.inputs for case in analysis.filter.pareto_set]
    print [case.inputs for case in analysis.MOEI.best_cases]
