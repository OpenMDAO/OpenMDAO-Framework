...
from openmdao.examples.multiEI.spiral_component import SpiralComponent
...
class MyDriver(Driver):
    def execute(self):
        ...
        print analysis.spiral_meta_model.x,analysis.spiral_meta_model.y
        case = Case(inputs = [('spiral_meta_model.x',None,analysis.spiral_meta_model.x), 
                              ('spiral_meta_model.y',None,analysis.spiral_meta_model.y)],
                    outputs = [('spiral_meta_model.f1_xy',None,analysis.spiral_meta_model.f1_xy),
                               ('spiral_meta_model.f2_xy',None,analysis.spiral_meta_model.f2_xy)])
...
class Analysis(Assembly):
    def __init__(self,*args,**kwargs):
        ...
        #self.spiral_meta_model.includes = ['x','y','f1_xy','f2_xy']
        ...
        self.filter.case_set = self.spiral_meta_model.recorder.get_iterator()
