...
# plugin_package. DO NOT CHANGE IT if you plan to use plugin_package to package
# distribution.
...
#
# This file is autogenerated during plugin_quickstart and overwritten during
# plugin_package. DO NOT CHANGE IT if you plan to use plugin_package to update 
# the distribution.
#
...
def _get_template_options(cfg, **kwargs):
    if cfg.has_section('metadata'):
...
def plugin_quickstart(argv=None):
    ...
    try:
        ...
        template_options = _get_template_options(cfg, classname=classname)
...
def plugin_package(argv=None):
    """A command line script (plugin_package) points to this.  It creates a 
    ...
    usage: plugin_package [dist_dir_path]
    ...
    if len(argv) == 0:
        ...
        raise RuntimeError("\nusage: plugin_package [dist_dir_name]\n")
    ...
    try:
        ...
        template_options = _get_template_options(cfg)
