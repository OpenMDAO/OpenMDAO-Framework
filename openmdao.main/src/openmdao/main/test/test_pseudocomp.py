...
class PseudoCompTestCase(unittest.TestCase):
    ...
    def test_basic_units(self):
        top = _simple_model()
        self.assertEqual(set(top._depgraph._graph.nodes()),
                         set(['comp1','comp2','_pseudo_0']+self.fakes))
        self.assertEqual(set(top._depgraph.list_connections()),
    ...
    def test_multi_src(self):
        ...
        self.assertEqual(set(top._depgraph._graph.nodes()),
                         set(['comp1','comp2', 
                              '_pseudo_0', '_pseudo_1']+self.fakes))
        self.assertEqual(set(top._depgraph.list_connections()),
        ...
        self.assertEqual(set(top._depgraph._graph.nodes()),
                         set(['comp1','comp2', '_pseudo_0', '_pseudo_2']+self.fakes))
        self.assertEqual(set(top._depgraph.list_connections()),
                         set([('_pseudo_0.out0', 'comp2.a'), ('comp1.c', '_pseudo_0.in0'),
        ...
        self.assertEqual(set(top._depgraph._graph.nodes()),
                         set(['comp1','comp2', '_pseudo_0', '_pseudo_3']+self.fakes))
        self.assertEqual(set(top._depgraph.list_connections()),
                         set([('_pseudo_0.out0', 'comp2.a'), ('comp1.c', '_pseudo_0.in0'),
