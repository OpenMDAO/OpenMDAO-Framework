...
# TODO: this test has problems with unnecessary dependencies generated by eggsaver
#       there also seems to be a bug in which the installed egg is using the
#       system version of pyparsing rather than the virtualenv version
        raise nose.SkipTest()
