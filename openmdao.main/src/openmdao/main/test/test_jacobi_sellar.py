...
from openmdao.lib.drivers.api import MPI_FixedPointIterator
...
class SellarMDF(Assembly):
    ...
    def configure(self):
        ...
        self.add('driver', MPI_Optimizer())
        
        # Outer Loop - Global Optimization
        self.add('solver', MPI_FixedPointIterator())
        self.driver.workflow.add(['solver'])

        # Inner Loop - Full Multidisciplinary Solve via fixed point iteration
        dis1 = self.add('dis1', sellar.Discipline1_WithDerivatives())
        dis1.mpi_options.cpus = 1

        dis2 = self.add('dis2', sellar.Discipline2_WithDerivatives())
        dis2.mpi_options.cpus = 1
        ...
        # Make all connections // no connections in jacobi
        ...
        self.driver.add_parameter('dis1.y1', low==-1e99, high=1e99)
