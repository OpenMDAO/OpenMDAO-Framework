...
from conmindriver.conmindriver import CONMINdriver
...
top.driver.constraints = ['40.-(20.*design_vals[0]+12.*design_vals[1]+11.*design_vals[2]+7.*design_vals[3]+4.*design_vals[4])']
