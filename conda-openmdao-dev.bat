...
REM SET DEPENDENCIES=numpy
REM SET DEPENDENCIES=%DEPENDENCIES% scipy
REM SET DEPENDENCIES=%DEPENDENCIES% setuptools
REM SET DEPENDENCIES=%DEPENDENCIES% pyparsing
REM SET DEPENDENCIES=%DEPENDENCIES% traits==4.3.0
REM SET DEPENDENCIES=%DEPENDENCIES% nose
REM SET DEPENDENCIES=%DEPENDENCIES% sphinx
SET DEPENDENCIES=%DEPENDENCIES% "fabric==0.9.3"
REM SET DEPENDENCIES=%DEPENDENCIES% virtualenv
...
REM SET DEPENDENCIES=%DEPENDENCIES% zope.interface
REM SET DEPENDENCIES=%DEPENDENCIES% "pytz>=2011"
REM SET DEPENDENCIES=%DEPENDENCIES% pycrypto==2.3
REM SET DEPENDENCIES=%DEPENDENCIES% cobyla
REM SET DEPENDENCIES=%DEPENDENCIES% conmin
REM SET DEPENDENCIES=%DEPENDENCIES% newsumt
REM SET DEPENDENCIES=%DEPENDENCIES% slsqp
